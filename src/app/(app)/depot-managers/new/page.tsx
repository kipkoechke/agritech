...
import { useCreateDepotManager } from "@/hooks/useDepotManager";
...
export default function NewDepotManagerPage() {
  const router = useRouter();
  const createMutation = useCreateDepotManager();
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs md:text-sm text-gray-600 mt-0.5">
                Create a new depot manager account
              </p>
            </div>
          </div>
        </div>
