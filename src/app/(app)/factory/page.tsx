    ...
    <div className="min-h-screen p-4">
      ...
      {factories.length === 0 ? (
        <div className="bg-white rounded-lg border border-gray-200 p-8 text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">No factories yet</h3>
          <p className="text-gray-500 mb-4">Get started by adding your first factory.</p>
          <Link
            href="/factories/new"
