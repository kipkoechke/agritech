...
import {useDeleteProduct, useProduct, useProductPriceHistory,} from "@/hooks/useProduct";
...
export default function ProductDetailPage({params}: ProductDetailPageProps) {
    ...
    const {data: priceHistory} = useProductPriceHistory(id);
    ...
    return (
        <div className="absolute inset-0 flex flex-col overflow-hidden bg-gray-50 px-4 md:px-8 py-2 pb-24 md:pb-4">
            <div className="container mx-auto flex-1 min-h-0 flex flex-col max-w-5xl">
                {/* Header */}
                <div
                    className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-4 md:mb-6 shrink-0">
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex items-start md:items-center gap-3 flex-1 min-w-0">
                            <div
                                className="hidden md:flex items-center justify-center w-10 h-10 rounded-lg overflow-hidden shrink-0">
                                {product.image ? (
                                    <Image
                                    ...
                                    <div
                                        className="w-full h-full bg-primary/10 text-primary flex items-center justify-center">
                    ...
                    <div className="flex items-center gap-2 ml-13 md:ml-0">
                        ...
                        <Modal>
                            <Modal.Open opens="delete-product">
                                <button
                                    className="px-3 md:px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 font-medium text-sm inline-flex items-center gap-2">
                ...
                <div className="flex-1 overflow-y-auto space-y-4">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        ...
                        <div className="bg-white rounded-lg border border-gray-200 p-4 mt-4">
                            ...
                            {product.image && (
                                <div
                                    className="relative w-full h-48 rounded-lg overflow-hidden border border-gray-200 mb-4">
                                    <Image
                                        loader={laravelLoader}
                                        src={product.image}
                                        alt={product.name}
                  ...
                  <span>
                    ...
                    Updated:{" "}
                        ...
                        <div className="bg-white rounded-lg border border-gray-200 p-4 mt-4">
                            ...
                            {product.purchase_volumes &&
                            product.purchase_volumes.length > 0 ? (
                                        ...
                                        >
                                            <div>
                                                ...
                                                <p className="text-xs text-gray-500">
                                                    {volume.min_quantity} - {volume.max_quantity || "∞"}{" "}
                                                    units
                                                </p>
                                            </div>
                    ...
                    {priceHistory && priceHistory.data.length > 0 && (
                        ...
                        <span className="text-sm text-gray-500 line-through">
                          {formatPrice(history.old_price)}
                                                ...
                                                <span
                                                    className={`text-sm font-medium ${isIncrease ? "text-red-600" : "text-emerald-600"}`}
                                                >
