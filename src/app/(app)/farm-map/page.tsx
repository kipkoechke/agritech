...
export default function FarmMapPage() {
  ...
  const stats = useMemo(() => {
    ...
    const totalKilos = filteredFarms.reduce(
      (sum, farm) => sum + farm.totalKilos,
      0,
    );
          ...
          <div className="border-t border-gray-100 px-3 md:px-4 py-3">
            ...
            <div className="flex justify-end mt-3">
              <button
                ...
                disabled={!zone && !factory}
                className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors flex items-center gap-2 ${zone || factory ? "text-gray-700 bg-gray-100 hover:bg-gray-200" : "text-gray-400 bg-gray-50 cursor-not-allowed"}`}
              >
          ...
          <div className="p-3 md:p-4">
            ...
            <div className="mt-3 flex flex-wrap gap-4 justify-center">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-gray-600">High (500+ KG)</span>
              </div>
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-gray-600">Low (300-399 KG)</span>
              </div>
              <div className="flex items-center gap-2">
