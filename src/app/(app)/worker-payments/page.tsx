...
export default function WorkerPaymentsPage() {
  ...
  const { data: supervisorsData } = useHrisUsers({
    role: "supervisor",
    per_page: 100,
  });
  ...
  const { data: paymentRequestsData, isLoading: paymentRequestsLoading } =
    usePaymentRequests({
      from_date: fromDate,
      to_date: toDate,
    });
                    ...
                    {paymentRequestsData.data.map((pr: any) => (
                      <tr key={pr.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                          {pr.scheduled_date
                            ? new Date(pr.scheduled_date).toLocaleDateString()
                            : "—"}
                        </td>
                        ...
                        <td className="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                          {pr.total_farm_kgs?.toLocaleString() || 0}
                        </td>
                        <td className="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                          {pr.total_factory_kgs?.toLocaleString() || 0}
                        </td>
