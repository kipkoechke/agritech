...
import { useCreateSalesPersonPortalCustomer } from "@/hooks/useSalesPersonPortal";
...
export default function NewSalesPersonCustomerPage() {
  const router = useRouter();
  const createMutation = useCreateSalesPersonPortalCustomer();
  ...
  const onSubmit = (data: CustomerFormData) => {
    ...
    const payload = {
      ...
      metadata: {
        ...
        is_tax_exempt: data.is_tax_exempt || undefined,
      },
    };
    ...
    createMutation.mutate(payload, {
      onSuccess: () => {
        ...
        router.push("/sales-person/customers");
      },
  ...
  return (
    <div className="absolute inset-0 flex flex-col overflow-hidden bg-gray-50 px-3 md:px-8 py-2">
      <div className="container mx-auto flex-1 min-h-0 flex flex-col max-w-3xl">
        ...
        <div className="flex items-center gap-2 md:gap-3 mb-4 shrink-0">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div>
              ...
              <p className="hidden md:block text-sm text-gray-600 mt-0.5">
        ...
        <div className="flex-1 overflow-y-auto pb-20 md:pb-4">
          ...
          >
              ...
              <div className="border-t border-gray-200 pt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <InputField
                    ...
                    error={
                      errors.postal_code?.message || getApiError("postal_code")
                    }
                  />
                </div>
              </div>
            ...
            <div className="flex flex-col-reverse md:flex-row gap-3 justify-end pt-4 mt-4 border-t border-gray-200">
              <Link
                href="/sales-person/customers"
                className="px-5 py-2.5 md:py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 font-medium text-sm text-center"
              >
                Cancel
              </Link>
              <button
                ...
                className="px-5 py-2.5 md:py-2 bg-accent text-white rounded-lg hover:bg-accent/90 font-medium disabled:opacity-50 disabled:cursor-not-allowed text-sm"
              >
