...
const DISPATCH_REPORT_OPTIONS = [
  {
    value: "",
    label: "All Dispatches",
    description: "Complete list of all dispatches",
  ...
  },
  {
    value: "dispatched",
    label: "Dispatched",
    description: "Dispatches that have been sent out",
    icon: MdCheckCircle,
    color: "text-blue-600",
    bgColor: "bg-blue-50",
  },
  {
    value: "pending",
    label: "Pending",
    description: "Dispatches awaiting processing",
    icon: MdPending,
        ...
        <div className="px-5 py-4 space-y-5">
          ...
          <div>
            ...
            <div className="space-y-2">
              {DISPATCH_REPORT_OPTIONS.map((option) => {
