...
interface StockRequestReportModalProps {
  isOpen: boolean;
  onClose: () => void;
  onGenerate: (params: StockRequestReportParams) => void;
  isGenerating: boolean;
  title?: string;
}

const STOCK_REQUEST_REPORT_OPTIONS = [
  {
    value: "",
    label: "All Requests",
    description: "Complete list of all stock requests",
    icon: MdCallMade,
  ...
  },
  {
    value: "fulfilled",
    label: "Fulfilled",
    description: "Requests that have been fulfilled",
    icon: MdCallReceived,
...
export default function StockRequestReportModal({
  isOpen,
  onClose,
  onGenerate,
  isGenerating,
  title = "Generate Stock Requests Report",
}: StockRequestReportModalProps) {
  ...
  }, [selectedFilter, dateFrom, dateTo, onGenerate]);
        ...
        <div className="px-5 py-4 space-y-5">
          ...
          <div>
            ...
            <div className="space-y-2">
              {STOCK_REQUEST_REPORT_OPTIONS.map((option) => {
